This version used the NASA GeneLab overview page (https://genelab.nasa.gov/overview) to introduce the Rock and roll space wizard to the GeneLab spacebiology solutions using the Google Gemini pro model  
